...
if selected_kpi == "Final score":
    ...
    # Y축에 로그 스케일 적용(로그 스케일은 값 0을 허용하지 않으므로 데이터가 모두 양수여야 합니다)
    fig_line.update_layout(
        title = {'text': "Weekly Trend of Final score (Cumulative, Log Scale)", 'x':0.5, 'xanchor': 'center', 'font': {'size': 13}},
        xaxis_title = "Week",
        yaxis_title = "Cumulative Final Score (log scale)",
        ...
        yaxis = dict(type="log", showgrid=True, gridcolor='LightGray', gridwidth=1),
